...
const RemoveFiles = () => {
    ...
    useEffect(() => {
        ...
        const fetchFiles = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/program-selection/list-files`);
    ...
    const handleRemoveFiles = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/program-selection/remove-files`, {
